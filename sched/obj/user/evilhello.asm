...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000dd:	50                   	push   %eax
  8000de:	52                   	push   %edx
  8000df:	68 6a 0e 80 00       	push   $0x800e6a
  8000e4:	6a 23                	push   $0x23
  8000e6:	68 87 0e 80 00       	push   $0x800e87
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8002bd:	56                   	push   %esi
  8002be:	50                   	push   %eax
  8002bf:	68 98 0e 80 00       	push   $0x800e98
  ...
  8002d0:	e8 56 00 00 00       	call   80032b <vcprintf>
	cprintf("\n");
  8002d5:	c7 04 24 bc 0e 80 00 	movl   $0x800ebc,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800425:	0f be 80 be 0e 80 00 	movsbl 0x800ebe(%eax),%eax
  80042c:	50                   	push   %eax
...
008004e5 <vprintfmt>:
{
  ...
  80060c:	52                   	push   %edx
  80060d:	68 df 0e 80 00       	push   $0x800edf
  800612:	57                   	push   %edi
  800613:	56                   	push   %esi
  ...
  800621:	50                   	push   %eax
  800622:	68 d6 0e 80 00       	push   $0x800ed6
  800627:	57                   	push   %edi
  800628:	56                   	push   %esi
  ...
  800643:	b8 cf 0e 80 00       	mov    $0x800ecf,%eax
