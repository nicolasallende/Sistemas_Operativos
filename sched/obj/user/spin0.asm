...
obj/user/spin0:     file format elf32-i386
...
umain(int argc, char **argv)
{
  ...
  80003c:	e8 aa 0a 00 00       	call   800aeb <sys_getenvid>
  ...
  800052:	53                   	push   %ebx
  800053:	57                   	push   %edi
  800054:	68 e8 0e 80 00       	push   $0x800ee8
  800059:	e8 36 01 00 00       	call   800194 <cprintf>
  ...
  800075:	53                   	push   %ebx
  800076:	57                   	push   %edi
  800077:	68 c0 0e 80 00       	push   $0x800ec0
  80007c:	e8 13 01 00 00       	call   800194 <cprintf>
			sys_yield();
  800081:	e8 89 0a 00 00       	call   800b0f <sys_yield>
	while (n++ < 5 || !yield) {
  800086:	83 c4 10             	add    $0x10,%esp
  800089:	83 fb 04             	cmp    $0x4,%ebx
  80008c:	0f 96 c2             	setbe  %dl
  80008f:	85 f6                	test   %esi,%esi
  800091:	0f 94 c0             	sete   %al
  800094:	83 c3 01             	add    $0x1,%ebx
  800097:	08 c2                	or     %al,%dl
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80023d:	0f be 80 18 0f 80 00 	movsbl 0x800f18(%eax),%eax
  800244:	50                   	push   %eax
...
008002fd <vprintfmt>:
{
  ...
  80034d:	ff 24 85 e0 0f 80 00 	jmp    *0x800fe0(,%eax,4)
  ...
  800419:	8b 14 85 40 11 80 00 	mov    0x801140(,%eax,4),%edx
  800420:	85 d2                	test   %edx,%edx
  800422:	74 15                	je     800439 <vprintfmt+0x13c>
				printfmt(putch, putdat, "%s", p);
  800424:	52                   	push   %edx
  800425:	68 39 0f 80 00       	push   $0x800f39
  80042a:	57                   	push   %edi
  80042b:	56                   	push   %esi
  ...
  800439:	50                   	push   %eax
  80043a:	68 30 0f 80 00       	push   $0x800f30
  80043f:	57                   	push   %edi
  800440:	56                   	push   %esi
  ...
  80045b:	b8 29 0f 80 00       	mov    $0x800f29,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a6c:	50                   	push   %eax
  800a6d:	52                   	push   %edx
  800a6e:	68 64 11 80 00       	push   $0x801164
  800a73:	6a 23                	push   $0x23
  800a75:	68 81 11 80 00       	push   $0x801181
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800c4c:	56                   	push   %esi
  800c4d:	50                   	push   %eax
  800c4e:	68 90 11 80 00       	push   $0x801190
  ...
  800c5f:	e8 df f4 ff ff       	call   800143 <vcprintf>
	cprintf("\n");
  800c64:	c7 04 24 b4 11 80 00 	movl   $0x8011b4,(%esp)
