	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e8:	0f be 80 a8 0e 80 00 	movsbl 0x800ea8(%eax),%eax
  8001ef:	50                   	push   %eax
...
008002a8 <vprintfmt>:
{
  ...
  8002f8:	ff 24 85 60 0f 80 00 	jmp    *0x800f60(,%eax,4)
  ...
  8003c4:	8b 14 85 c0 10 80 00 	mov    0x8010c0(,%eax,4),%edx
  8003cb:	85 d2                	test   %edx,%edx
  8003cd:	74 15                	je     8003e4 <vprintfmt+0x13c>
				printfmt(putch, putdat, "%s", p);
  8003cf:	52                   	push   %edx
  8003d0:	68 c9 0e 80 00       	push   $0x800ec9
  8003d5:	57                   	push   %edi
  8003d6:	56                   	push   %esi
  ...
  8003e4:	50                   	push   %eax
  8003e5:	68 c0 0e 80 00       	push   $0x800ec0
  8003ea:	57                   	push   %edi
  8003eb:	56                   	push   %esi
  ...
  800406:	b8 b9 0e 80 00       	mov    $0x800eb9,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a17:	50                   	push   %eax
  800a18:	52                   	push   %edx
  800a19:	68 e4 10 80 00       	push   $0x8010e4
  800a1e:	6a 23                	push   $0x23
  800a20:	68 01 11 80 00       	push   $0x801101
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800bf7:	56                   	push   %esi
  800bf8:	50                   	push   %eax
  800bf9:	68 10 11 80 00       	push   $0x801110
  ...
  800c0a:	e8 df f4 ff ff       	call   8000ee <vcprintf>
	cprintf("\n");
  800c0f:	c7 04 24 9c 0e 80 00 	movl   $0x800e9c,(%esp)
